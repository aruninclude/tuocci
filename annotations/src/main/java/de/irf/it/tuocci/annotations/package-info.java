 ...
 * <ul>
 *     <li>
 *         the {@link de.irf.it.tuocci.annotations.Category} it
 *         represents, used to classify the resource towards OCCI clients;
 *     </li>
 *     <li>
 *         the class of the resource, being either {@link de.irf.it.tuocci.annotations.Kind}
 *         or {@link de.irf.it.tuocci.annotations.Mixin}; and
 *     </li>
 *     <li>
 *         the {@link de.irf.it.tuocci.annotations.Attribute}s and
 *         {@link de.irf.it.tuocci.annotations.Action}s it supports.
 *     </li>
 * </ul>
 *
 * Besides this, it allows arbitrary types declared as a <code>Kind</code> to
 * indicate via the {@link de.irf.it.tuocci.annotations.Attaches} whether
 ...
 *
 */
package de.irf.it.tuocci.annotations;
